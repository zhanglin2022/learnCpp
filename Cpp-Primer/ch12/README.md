...
(a) illegal, invalid conversion from `int` to `std::unique_ptr<int>::pointer`
(b) The code below can compile, but will cause error at run time. The reason is that when the unique_ptr p1 is out of scope, delete will be called to free the object. But the object is not allocate using new.Thus, an error would be thrown by operating system.
...
(d) The code below can compile, but when the unique_ptr goes out of scope, it will call delete to free an obeject not allocated using new.
(e) legal
...
## Exercise 12.19 [Header](ex12_19.h)|[Test](ex12_19_TEST.cpp)
...
## Exercise 12.22 [Header](ex12_22.h)|[Test](ex12_22_TEST.cpp)
...
## Exercise 12.27 [Header](ex12_27_30.h)|[Test](ex12_27_30_TEST.cpp)

## [Exercise 12.28](ex12_28.cpp)

## [Exercise 12.29](ex12_29.cpp)
...
I prefer `do while` format, because it looks cleaner.
...
## Exercise 12.30 [Header](ex12_27_30.h)|[Test](ex12_27_30_TEST.cpp)
...
## Exercise 12.32 [Header](ex12_32.h)|[Test](ex12_32_TEST.cpp)
## Exercise 12.33 [Header](ex12_33.h)|[Test](ex12_33_TEST.cpp)
