...
// and day. 
// Write a constructor that takes a string representing a date. Your constructor 
// should handle a variety of date formats, 
...
public:
    ...
    void print() { cout << "day:" << day << " " << "month: " << month << " " << "year: " << year; }
};
