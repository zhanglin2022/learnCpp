...
int main() {
    ...
    D1 *dp1 = &d1obj; D2 *dp2 = &d2obj;
    // bp2->f2();  // error: ‘class Base’ has no member named ‘f2’ 
    // dp1->f2();  // virtual call, will call D1::f2() at run time
    // dp2->f2();  // virtual call, will call D2::f2() at run time
